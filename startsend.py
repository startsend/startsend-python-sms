...
class StartSend:
    __token = ''
    __api_url = ''
    __api_url_dict = {'by': 'https://app.sms.by/api/v1/', 'ru': 'https://app.startsend.ru/api/v1/'}

    __by_gate_url = 'https://app.sms.by/'
    __ru_gate_url = 'https://app.startsend.ru/'

    """
    Инициализация класса 

    Args:
        token: Токен для отсулки сообщения  
        country_code: Код страны 'by' Белларусь и 'ru' Россия  соответственно выбирается гейт для отправки 
        https://app.sms.by/ или https://app.startsend.ru/
